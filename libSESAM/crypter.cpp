...
Crypter *Crypter::instance(void)
{
  static Crypter *singleInstance = new Crypter;
 ...
 */
QByteArray Crypter::encrypt(const SecureByteArray &key, const SecureByteArray &IV, const QByteArray &plain, CryptoPP::StreamTransformationFilter::BlockPaddingScheme padding) const
{
 ...
 */
SecureByteArray Crypter::decrypt(const SecureByteArray &key, const SecureByteArray &IV, const QByteArray &cipher, CryptoPP::StreamTransformationFilter::BlockPaddingScheme padding) const
{
 ...
 */
QByteArray Crypter::randomBytes(const int size) const
{
 ...
 */
SecureByteArray Crypter::generateKGK(void) const
{
 ...
 */
QByteArray Crypter::generateSalt(void) const
{
 ...
 */
SecureByteArray Crypter::makeKeyFromPassword(const SecureByteArray &masterKey, const QByteArray &salt) const
{
 ...
 */
void Crypter::makeKeyAndIVFromPassword(const SecureByteArray &masterPassword, const QByteArray &salt, SecureByteArray &key, SecureByteArray &IV) const
{
